...
def load_and_prepare_data():
    sample_df = pd.read_csv(
        os.path.join(data_dir, r"C:\Users\chand\Documents\GitHub\Thesis\M3-1.2mM\Sample_M3\M3_1.2mM\Pressure_RT\raw_meas\merged_pressure_log_RT.csv"),
        usecols=["Elapsed Time (hours)", "ABP2-Sch1 (kPa)", "Date", "Time", "Temperature (C)"]
    )
    sample_df = sample_df[sample_df["Elapsed Time (hours)"] > 20 / 60]
